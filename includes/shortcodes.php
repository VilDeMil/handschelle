...
class Handschelle_Shortcodes {
    ...
    /**
     * Returns the "🤖 KI-Analyse" anchor HTML for a given name + partei + straftat,
     * or an empty string if straftat is empty.
        ...
        <div class="hs-card" id="hs-card-<?php echo intval($e->id); ?>">
            ...
            <?php endif; // is_logged_in ?>
                ...
                <div class="hs-card-section">
                    ...
                    <div class="hs-search-buttons">
                        <small>Mehr infos:</small>
                        <?php echo $this->ki_analyse_link( $e->name, $e->partei, $e->straftat ); ?>
                ...
                <div class="hs-card-extra-offence">
                    ...
                    <div class="hs-search-buttons">
                        <small>Mehr infos:</small>
                        <?php echo $this->ki_analyse_link( $e->name, $e->partei, $off->straftat ); ?>
    ...
    public function sc_ticker( $atts ) {
        ...
        foreach ( $rows as $r ) {
            ...
            $ki       = $is_logged_in ? ' ' . $this->ki_analyse_link( $r->name, $r->partei, $r->straftat ) : '';
    ...
    public function sc_ticker_icons( $atts ) {
        ...
        foreach ( $rows as $r ) {
            ...
            $straftat        = $r->straftat        ? ' <span class="hs-st-straftat">' . esc_html( $r->straftat )      . '</span>' : '';
            $status_straftat = $r->status_straftat ? ' <span class="hs-st-status">'  . esc_html( $r->status_straftat ). '</span>' : '';
            $ki              = is_user_logged_in() ? ' ' . $this->ki_analyse_link( $r->name, $r->partei, $r->straftat ) : '';
        ...
        <div class="hs-wanted-wrap hs-frontend">
            <div class="hs-wanted-card">
                ...
                <div class="hs-wanted-footer">
                    ...
                    <?php if ( $is_logged_in && $e->straftat ) echo $this->ki_analyse_link( $e->name, $e->partei, $e->straftat ); ?>
    ...
    public function sc_chat( $atts ) {
        ...
        <div class="hs-chat-widget" id="<?php echo esc_attr( $uid ); ?>"
             ...
             <?php endif; ?>
             <?php
             $hs_name_url = sanitize_text_field( wp_unslash( $_GET['hs_name'] ?? '' ) );
             if ( $hs_name_url !== '' ) :
             ?>
             data-hs-name="<?php echo esc_attr( $hs_name_url ); ?>"
             <?php endif; ?>>
            ...
            <div class="hs-chat-header">
                ...
                <button type="button" class="hs-chat-settings-btn is-open" title="Einstellungen" aria-expanded="true">
            ...
            <div class="hs-chat-settings-panel">
    ...
    public function sc_chat_dropdown( $atts ) {
        ...
        <div class="hs-chat-widget hs-chat-widget-dropdown" id="<?php echo esc_attr( $uid ); ?>"
             ...
             <?php endif; ?>
             <?php
             $hs_name_url_dd = sanitize_text_field( wp_unslash( $_GET['hs_name'] ?? '' ) );
             if ( $hs_name_url_dd !== '' ) :
             ?>
             data-hs-name="<?php echo esc_attr( $hs_name_url_dd ); ?>"
             <?php endif; ?>>
