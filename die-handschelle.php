...
define( 'HANDSCHELLE_VERSION',           '7.2' );
define( 'HANDSCHELLE_PLUGIN_DIR',        plugin_dir_path( __FILE__ ) );
define( 'HANDSCHELLE_PLUGIN_URL',        plugin_dir_url( __FILE__ ) );
define( 'HANDSCHELLE_DB_TABLE',          'die_handschelle' );          // legacy (migration source)
define( 'HANDSCHELLE_DB_TABLE_PERSONEN',   'die_handschelle_personen' );
define( 'HANDSCHELLE_DB_TABLE_STRAFTATEN', 'die_handschelle_straftaten' );
